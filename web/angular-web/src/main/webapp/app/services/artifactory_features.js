...
export class ArtifactoryFeatures {
    ...
    isHidden(feature) {
        ...
        return (this.isAol() && _.includes(HIDDEN_AOL_FEATURES, feature) && !(this.isDedicatedAol() && _.includes(SHOW_ON_DEDICATED_AOL, feature))) ||
               (this.isOss() && _.includes(HIDDEN_OSS_FEATURES, feature)) ||
                (this.isEdgeNode() && _.includes(HIDDEN_EDGE_FEATURES, feature)) ||
                (this.isNonCommercial() && _.includes(HIDDEN_OSS_FEATURES, feature));
    }
