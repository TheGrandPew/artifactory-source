				...
				return [
					{
						...
						customActions: [{
							...
							visibleWhen: row => _.includes(row.actions, 'View')
						}],
						actions: {
							download: {
								callback: row => this.downloadSelectedItems(row),
								visibleWhen: row => _.includes(row.actions, 'Download')
							}
						}
					},
					{
						...
						customActions: [{
							...
							visibleWhen: row => _.includes(row.actions, 'ShowInTree')
						}]
					},
					{
						name: "Repository",
					...
					},
					{
						...
						actions: {
							delete: {
								...
								visibleWhen: row => _.includes(row.actions, 'Delete')
							}
						}
					}
				]
				...
				return [
					{
						...
						customActions: [
							...
							},
							{
								...
								visibleWhen: row => _.includes(row.actions, 'Restore')
							}
						],
						actions: {
							download: {
