...
export class AdminAdvancedStorageSummaryController {
    ...
    getStorageTableSummaryData() {
        ...
        let total = _.find(this.storageSummary.repositoriesSummaryList, {repoKey: {value: 'TOTAL'}});
        let trash = _.find(this.storageSummary.repositoriesSummaryList, {repoKey: {value: 'Trash Can'}});
        let supportBundle = _.find(this.storageSummary.repositoriesSummaryList, {repoKey: {value: 'Support Bundle'}});
