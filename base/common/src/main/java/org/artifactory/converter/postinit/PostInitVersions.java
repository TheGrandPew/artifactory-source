...
public enum PostInitVersions {
    v100(new DockerInvalidImageLocationConverter(ArtifactoryVersionProvider.v4110.get(),
    ...
    v102(new RemoteRepoBypassHeadSystemPropsConverter(ArtifactoryVersionProvider.v640m007.get(),
