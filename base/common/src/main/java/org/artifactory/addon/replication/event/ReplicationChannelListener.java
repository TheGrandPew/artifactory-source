...
public interface ReplicationChannelListener {
    ...
    default ReplicationChannel establishReplicationChannel(ReplicationOwnerModel replicationOwnerModel,
        ...
        return establishReplicationChannel(replicationOwnerModel, targetNode, requestOrigin, null);
    }

    default ReplicationChannel establishReplicationChannel(ReplicationOwnerModel replicationOwnerModel,
            String targetNode, String requestOrigin, ArtifactoryVersion artifactoryVersion) {
        return null;
    }
