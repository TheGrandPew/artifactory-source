...
public class MavenServiceImpl implements MavenService {
    ...
    public MavenArtifactInfo getMavenArtifactInfo(File uploadedFile) {
        return MavenModelUtils.artifactInfoFromFile(uploadedFile, uploadedFile.getName());
    }

    @Override
    public MavenArtifactInfo getMavenArtifactInfo(File uploadedFile, String originalFileName) {
        return MavenModelUtils.artifactInfoFromFile(uploadedFile, originalFileName);
    }
