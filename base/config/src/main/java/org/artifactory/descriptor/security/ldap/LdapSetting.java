...
@XmlType(name = "LdapSettingType",
        propOrder = {"key", "enabled", "ldapUrl", "userDnPattern", "search", "autoCreateUser", "emailAttribute",
                "ldapPoisoningProtection", "allowUserToAccessProfile", "pagingSupportEnabled"},
...
public class LdapSetting implements Descriptor {
    ...
    private Boolean ldapPoisoningProtection=true;

    @XmlElement(defaultValue = "false")
    private boolean allowUserToAccessProfile = false;

    @XmlElement(defaultValue = "true")
    private boolean pagingSupportEnabled = true;
    ...
    public LdapSetting(LdapSetting ldapSetting) {
        ...
        this.pagingSupportEnabled = ldapSetting.pagingSupportEnabled;
    }
    ...
    public Boolean getLdapPoisoningProtection() {
        return ldapPoisoningProtection;
    }

    public void setLdapPoisoningProtection(Boolean ldapPoisoningProtection) {
        this.ldapPoisoningProtection = ldapPoisoningProtection;
    }

    public boolean isPagingSupportEnabled() {
        return pagingSupportEnabled;
    }

    public void setPagingSupportEnabled(boolean pagingSupportEnabled) {
    ...
    public boolean identicalConfiguration(LdapSetting that) {
        ...
        if (pagingSupportEnabled != that.pagingSupportEnabled) {
            return false;
        }
        return ldapPoisoningProtection != null ? ldapPoisoningProtection.
                equals(that.ldapPoisoningProtection) : that.ldapPoisoningProtection == null;
    }
    ...
    public boolean equals(Object o) {
        ...
        return key != null && key.equals(setting.key);
    }
